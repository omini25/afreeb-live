    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const filteredProducts = response.data.products.filter(product => product.product_status !== 'suspended' && product.product_status !== 'inactive');
...
// import {server} from "../mainServer";
//
// const ProductsFullWidth = ({ products, productFilters, fetchProduct, data }) => {
